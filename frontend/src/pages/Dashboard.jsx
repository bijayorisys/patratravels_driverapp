    ...
    <div style={styles.mainWrapper}>
      <div style={styles.appContainer}>
        <div className="px-2 pt-2">
          ...
          <div className="d-flex align-items-end justify-content-between mb-3 px-3 pt-2">
            <div>
              <h6
            ...
            <div className="bg-white px-3 py-1 rounded-pill shadow-sm border">
              <span
          ...
          {/* === TRIP LIST CONTAINER === */}
          <div className="trip-list pb-5 px-2">
            {loadingTrips ? (
              <div className="text-center py-5">
                <div
                  ...
                  role="status"
                ></div>
                <p className="mt-2 text-muted fw-medium small">
                  Loading schedule...
                </p>
              </div>
            ) : todayTrips.length > 0 ? (
              todayTrips.map((trip) => (
                <div
                  key={trip.enq_id}
                  // --- UPDATED ONCLICK LOGIC START ---
                  onClick={() => {
                    if (!isOnline || Number(dutyStatus) !== 1) {
                      // Show the alert if conditions are not met
                      Swal.fire({
                        icon: "warning",
                    ...
                    // If conditions are met, proceed to details
                    navigate(`/my-trips/${trip.enq_id}`);
                  }}
                  ...
                  <div className="card-body p-0">
                      ...
                      <div className="d-flex align-items-center gap-2">
                        <div className="bg-light rounded px-2 py-1">
                          <span
                            ...
                            style={{ fontSize: "1.1rem" }}
                          >
                            {trip.arrive_time_name || "--:--"}
                          </span>
                        </div>
                        <span
                          className="badge bg-success bg-opacity-10 text-success fw-bold px-2 py-1 rounded-1"
                    ...
                    <div className="p-3 position-relative">
                      ...
                      >
                        ...
                        >
                          <div
                            className="bg-white border border-4 border-success rounded-circle"
                        ...
                        >
                          ...
                          >
                            {trip.itin_pickloc_name || "Pickup Point"}
                          </h6>
                          <p
                      ...
                      >
                        ...
                        >
                          <div
                            className="bg-danger rounded-1 shadow-sm"
                        ...
                        >
                          <h6
                            ...
                            style={{ fontSize: "0.95rem" }}
                          >
                            {trip.itin_drop_location || "Destination"}
                          </h6>
                          <p
                            className="text-muted small mb-0 text-truncate"
                            style={{ fontSize: "0.75rem" }}
                    ...
                    {/* --- FOOTER: PASSENGER & ACTION --- */}
                    <div className="bg-primary-subtle bg-opacity-50 p-3 d-flex align-items-center justify-content-between">
                      <div className="d-flex align-items-center gap-2">
                        <div
                        ...
                        <div>
                          ...
                          >
                            {trip.gustcust_name || "Guest"}
                          </div>
                          <div
                            className="d-flex align-items-center text-dark"
                            style={{ fontSize: "0.7rem" }}
                          >
                            <PhoneCall size={10} className="me-1" />{" "}
                            {trip.guestmob_no}
                          </div>
                        </div>
                      </div>
                      ...
                      <button
                        className="btn btn-primary rounded-pill px-4 shadow py-2"
                        style={{
                          fontSize: "0.8rem",
                          fontWeight: "600",
                          letterSpacing: "0.5px",
              ...
              <div className="text-center py-5">
                ...
                <p className="text-muted small px-4">
                  Your schedule is currently empty. Relax or check back later.
                </p>
              </div>
            )}
          </div>
